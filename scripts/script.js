...
import { openBookingModal, closeModal, handleBooking } from './booking/bookingModal.js';
...
function setupEventListeners(rooms) {
    // Search form submit
    document.getElementById('searchForm').addEventListener('submit', (e) => handleSearch(e, rooms));
    ...
    // Booking form submit
    document.getElementById('bookingForm').addEventListener('submit', (e) => handleBooking(e, rooms));
